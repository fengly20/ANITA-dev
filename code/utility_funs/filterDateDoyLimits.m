function [x,y,doy_vec] = filterDateDoyLimits(x,y,doy_vec,date_limits,doy_limits)

% the filter is in three fold: 
% (1) no y values out of dates_limits
% (2) no y values out of doy_limits
% (3) no nan y values 
